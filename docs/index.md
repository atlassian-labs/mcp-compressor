...
- **Multiple Compression Levels**: Choose between `full`, `brief`, `minimal`, or `none`
...
mcp-compressor https://api.githubcopilot.com/mcp/ \
  --server-name github
...
Contributions are welcome! Please see [CONTRIBUTING.md](https://github.com/atlassian/mcp-compressor/blob/main/CONTRIBUTING.md) for details.

## License

This project is licensed under the terms specified in the [LICENSE](https://github.com/atlassian/mcp-compressor/blob/main/LICENSE) file.
